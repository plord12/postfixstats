...
test: ${BINDIR}/${NAME}
	${BINDIR}/${NAME} --verbose --domain u3acommunities.org --domain u3a.social --startdate=2026-03-01 testdata/mail*
	${BINDIR}/${NAME} --verbose --html --domain u3acommunities.org --domain u3a.social --startdate=2026-03-01 testdata/mail*
